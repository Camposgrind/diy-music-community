...
const mockQuery: GetBandsQuery = { name: 'Napalm', country: undefined, genreId: undefined, page: 1, pageSize: 20 };
...
describe('SearchStateService', () => {
  ...
  it('save() overwrites a previously saved state', () => {
    ...
    service.save({ query: { name: 'Discharge', country: undefined, genreId: undefined, page: 1, pageSize: 20 }, page: 3 });
