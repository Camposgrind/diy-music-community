...
- [ ] Band create/update endpoints require `[Authorize(Roles = "Admin")]`.
...
- Do not add proposal, claim, or moderation authorization paths; catalog writes belong exclusively to Admin.
